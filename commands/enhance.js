...
module.exports = {
  name: 'enhance',
  description: 'Enhance the picture from the user\'s image and send it directly to the user.',
  usage: 'enhance',
  author: 'kenlie',
  ...
  async execute(senderId, args, pageAccessToken) {
    ...
    if (imageData[senderId]) {
      ...
      try {
        ...
        const response = await axios.get(`https://api.kenliejugarap.com/imgupscaled/?imgurl=${encodeURIComponent(imgUrl)}`);
